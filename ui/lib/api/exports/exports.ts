...
const {mutation: mutationOptions, request: requestOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
  ...
  return `/api/v1/exports/project`
}

export const exportProject = async ( options?: RequestInit): Promise<ExportProjectResult> => {

  return fetchApi<ExportProjectResult>(getExportProjectUrl(),
  {
    ...options,
    method: 'POST'
...
export const getExportProjectMutationOptions = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof exportProject>>, TError,void, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof exportProject>>, TError,void, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof exportProject>>, void> = () => {


          return  exportProject(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ExportProjectMutationError = ApiError

    export const useExportProject = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof exportProject>>, TError,void, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getExportProjectMutationOptions(options), queryClient);
    }
