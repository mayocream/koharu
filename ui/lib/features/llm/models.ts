import type { LlmModelInfo, LlmState } from '@/lib/contracts/protocol'
import {
  ALL_PRESETS,
...
import { COMPATIBLE_PROVIDER_ID, PROVIDER_IDS } from './providers'
import type { LocalLlmPresetConfig } from '@/lib/state/preferences/store'
...
export const toBackendModelId = (modelId: string): string =>
  parseLlmModelIdentity(modelId).backendModelId
