...
export function Canvas() {
  ...
  return <div className="flex min-h-0 flex-1 items-start justify-center overflow-auto bg-white" />;
}
...
export function CanvasControl() {
  ...
  return (
    <div className="flex items-center justify-end gap-3 border border-neutral-300 px-2 py-1">
      <div className="flex items-center gap-1 text-sm text-neutral-500">Scale (%)</div>
    </div>
  );
}
