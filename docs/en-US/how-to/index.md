...
- [Use OpenAI-Compatible APIs](use-openai-compatible-api.md): configure the dedicated Atlas Cloud, LM Studio, and OpenRouter providers or connect other OpenAI-compatible endpoints
