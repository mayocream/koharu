...
- [PP-DocLayoutV3](https://huggingface.co/PaddlePaddle/PP-DocLayoutV3_safetensors)：文本检测与版面分析
- [comic-text-detector](https://huggingface.co/mayocream/comic-text-detector)：文本分割
- [PaddleOCR-VL-1.5](https://huggingface.co/PaddlePaddle/PaddleOCR-VL-1.5)：OCR 文本识别
- [lama-manga](https://huggingface.co/mayocream/lama-manga)：图像修复
- [YuzuMarker.FontDetection](https://huggingface.co/fffonion/yuzumarker-font-detection)：字体与颜色检测

为兼容 Rust 运行时并获得更好的性能，转换后的模型权重以 safetensors 格式托管在 [Hugging Face](https://huggingface.co/mayocream) 上。
