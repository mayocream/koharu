...
Koharu 可以接入 Atlas Cloud、OpenAI、Gemini、Claude、DeepSeek、OpenRouter、LM Studio，以及其他 OpenAI 兼容接口。

如果你要接入 Atlas Cloud、LM Studio、OpenRouter 或其他 OpenAI 风格端点，请参考 [使用 OpenAI 兼容 API](../how-to/use-openai-compatible-api.md)。
