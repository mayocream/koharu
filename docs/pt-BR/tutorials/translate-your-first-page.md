...
O Koharu pode usar Atlas Cloud, OpenAI, Gemini, Claude, DeepSeek, OpenRouter, LM Studio e outros endpoints compatíveis com OpenAI.

Se você quiser configurar o Atlas Cloud, o LM Studio, o OpenRouter ou outro endpoint no estilo OpenAI, siga [Use APIs compatíveis com OpenAI](../how-to/use-openai-compatible-api.md).
