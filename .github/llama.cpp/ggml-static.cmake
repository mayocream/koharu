...
file(REAL_PATH "${CMAKE_CURRENT_SOURCE_DIR}" _koharu_current_source)
file(REAL_PATH "${LLAMA_CPP_SOURCE_DIR}/ggml" _koharu_ggml_source)

if(_koharu_current_source STREQUAL _koharu_ggml_source)
